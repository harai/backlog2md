var bloggerBacklogMarkup = function() {
  ...
  var initBacklog = function() {
    ...
    var addPreviewStyles = function() {
      ...
      style.textContent = [, "#postingHtmlBox {", BOX_SIZING, "}"
        // based on http://www.w3.org/TR/CSS21/sample.html
        , "#emPreview address,#emPreview blockquote,#emPreview body,#emPreview dd,#emPreview div,#emPreview dl,#emPreview dt,#emPreview fieldset,#emPreview form,#emPreview frame,#emPreview frameset,#emPreview h1,#emPreview h2,#emPreview h3,#emPreview h4,#emPreview h5,#emPreview h6,#emPreview noframes,#emPreview ol,#emPreview p,#emPreview ul,#emPreview center,#emPreview dir,#emPreview hr,#emPreview menu,#emPreview pre{display:block;unicode-bidi:embed;}", "#emPreview li{display:list-item;}", "#emPreview head{display:none;}", "#emPreview table{display:table;}", "#emPreview tr{display:table-row;}", "#emPreview thead{display:table-header-group;}", "#emPreview tbody{display:table-row-group;}", "#emPreview tfoot{display:table-footer-group;}", "#emPreview col{display:table-column;}", "#emPreview colgroup{display:table-column-group;}", "#emPreview td,#emPreview th{display:table-cell;}", "#emPreview caption{display:table-caption;}", "#emPreview th{font-weight:bolder;text-align:center;}", "#emPreview caption{text-align:center;}", "#emPreview body{margin:8px;}", "#emPreview h1,#emPreview h2,#emPreview h3,#emPreview h4{font-size:2em;margin:0.67em 0;}", "#emPreview h5{font-size:1.5em;margin:0.75em 0;}", "#emPreview h6{font-size:1.17em;margin:0.83em 0;}", "#emPreview p,#emPreview blockquote,#emPreview ul,#emPreview fieldset,#emPreview form,#emPreview ol,#emPreview dl,#emPreview dir,#emPreview menu{margin:1.12em 0;}", "#emPreview h1,#emPreview h2,#emPreview h3,#emPreview h4,#emPreview h5,#emPreview h6,#emPreview b,#emPreview strong{font-weight:bolder;}", "#emPreview blockquote{margin-left:40px;margin-right:40px;}", "#emPreview i,#emPreview cite,#emPreview em,#emPreview var,#emPreview address{font-style:italic;}", "#emPreview pre,#emPreview tt,#emPreview code,#emPreview kbd,#emPreview samp{font-family:monospace;}", "#emPreview pre{white-space:pre;}", "#emPreview button,#emPreview textarea,#emPreview input,#emPreview select{display:inline-block;}", "#emPreview big{font-size:1.17em;}", "#emPreview small,#emPreview sub,#emPreview sup{font-size:0.83em;}", "#emPreview sub{vertical-align:sub;}", "#emPreview sup{vertical-align:super;}", "#emPreview table{border-spacing:2px;}", "#emPreview thead,#emPreview tbody,#emPreview tfoot{vertical-align:middle;}", "#emPreview td,#emPreview th,#emPreview tr{vertical-align:inherit;}", "#emPreview s,#emPreview strike,#emPreview del{text-decoration:line-through;}", "#emPreview hr{border:1px inset;}", "#emPreview ol,#emPreview ul,#emPreview dir,#emPreview menu,#emPreview dd{margin-left:40px;}", "#emPreview ol{list-style-type:decimal;}", "#emPreview ol ul,#emPreview ul ol,#emPreview ul ul,#emPreview ol ol{margin-top:0;margin-bottom:0;}", "#emPreview u,#emPreview ins{text-decoration:underline;}", "#emPreview br:before{content:\"\A\";white-space:pre-line;}", "#emPreview center{text-align:center;}", "#emPreview :link,#emPreview :visited{text-decoration:underline;}", "#emPreview :focus{outline:thin dotted invert;}"
        // original style
        , "#emPreview figure{display:block;margin-top:1em;margin-bottom:1em;margin-left:40px;margin-right:40px;}", "#emPreview div.previewOnly{margin:10px;font-size:13px;font-weight:bold;color:#888;}", "#emPreview h4,#emPreview h5,#emPreview h6{clear:both;}", '#emPreview figure.emebLeft{clear:left;float:left;}', '#emPreview figure.emebRight{clear:right;float:right;}', '#emPreview figure.emebCenter{clear:both;margin-left:auto;margin-right:auto;}', '#emPreview figure>div.emebImage{text-align:center;}', "#emPreview ol ul,#emPreview ul,#emPreview ul ul{list-style-type: disc;}", "#emPreview ol,#emPreview ul ol,#emPreview ol ol{list-style-type: decimal;}", "#emPreview dt{font-weight:bold;}", "#emPreview table,#emPreview th,#emPreview td{border:1px solid black;border-collapse:collapse;}", "#emPreview th,#emPreview td{padding:5px;}", "#emPreview pre,#emPreview table{margin:15px;}"
      ].join('\n');
  ...
  var extractBacklogOrNull = function(str) {
    ...
    return m[1].replace(/\{\{(\d+) hyphens\}\}/g, function($0, $1) {
  ...
  var styles = (function() {
    var styles = [, '<style type="text/css" scoped="scoped">', 'h4.emeb,h5.emeb,h6.emeb{clear:both;}', 'figure.emebLeft{clear:left;float:left;}', 'figure.emebRight{clear:right;float:right;}', 'figure.emebCenter{clear:both;margin-left:auto;margin-right:auto;}', 'figure>div.emebImage{text-align:center;}', '</style>'].join("\n") + "\n";
